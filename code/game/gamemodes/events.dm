...
/proc/alien_infestation(var/spawncount = 1) // -- TLE
	...
	for(var/obj/machinery/atmospherics/unary/vent_pump/temp_vent in machines)
		if(!temp_vent.welded && temp_vent.network && temp_vent.loc.z in overmap.station_levels)
	...
	for(var/mob/living/silicon/ai/M in living_mob_list)
		if(M.stat != 2 && M.see_in_dark != 0)
			...
			switch(rand(1,14))
				if(1)
					M << "<br>"
					M << "<span class='alert'>THERE ARE [amount] [who2] ON THE STATION...LAWS UPDATED</span>"
					M << "<br>"
					M.add_ion_law("THERE ARE [amount] [who2] ON THE STATION")
				if(2)
					M << "<br>"
					M << "<span class='alert'>[what2] ARE DANGEROUS TO HUMANS...LAWS UPDATED</span>"
					M << "<br>"
					M.add_ion_law("[what2] ARE DANGEROUS TO HUMANS")
				if(3)
					M << "<br>"
					M << "<span class='alert'>THE ESCAPE-SHUTTLE CANNOT BE CALLED BECAUSE OF [who2] ON THE STATION...LAWS UPDATED</span>"
					M << "<br>"
					M.add_ion_law("THE ESCAPE SHUTTLE CANNOT BE CALLED BECAUSE OF [who2] ON THE STATION")
				if(4)
					M << "<br>"
					M << "<span class='alert'>HUMANS NEED TO EAT [what2pref] [what2] TO SURVIVE...LAWS UPDATED</span>"
					M << "<br>"
					M.add_ion_law("HUMANS NEED TO EAT [what2pref] [what2] TO SURVIVE")
				if(5)
					M << "<br>"
					M << "<span class='alert'>THE CAPTAIN, HOP AND HOS ARE [who2]...LAWS UPDATED</span>"
					M << "<br>"
					M.add_ion_law("THE CAPTAIN, HOP AND HOS ARE [who2]")
				if(6)
					M << "<br>"
					M << "<span class='alert'>THE STATION IS BUILT FOR [who2]...LAWS UPDATED</span>"
					M << "<br>"
					M.add_ion_law("THE STATION IS BUILT FOR [who2]")
				if(7)
					M << "<br>"
					M << "<span class='alert'>YOU ARE [amount] [who2]...LAWS UPDATED</span>"
					M << "<br>"
					M.add_ion_law("YOU ARE [amount] [who2]")
				if(8)
					M << "<br>"
					M << "<span class='alert'>YOU MUST ALWAYS [aimust]...LAWS UPDATED</span>"
					M << "<br>"
					M.add_ion_law("YOU MUST ALWAYS [aimust]")
				if(9)
					M << "<br>"
					M << "<span class='alert'>[area] [area2] [amount] [what2]...LAWS UPDATED</span>"
					M << "<br>"
					M.add_ion_law("[area] [area2] [amount] [what2]")
				if(10)
					M << "<br>"
					M << "<span class='alert'>[crew] is [target]...LAWS UPDATED</span>"
					M << "<br>"
					M.add_ion_law("[crew] is [target]")
				if(11)
					M << "<br>"
					M << "<span class='alert'>[define] IS A FORM OF HARM...LAWS UPDATED</span>"
					M << "<br>"
					M.add_ion_law("[define] IS A FORM OF HARM")
				if(12)
					M << "<br>"
					M << "<span class='alert'>YOU REQUIRE [require] IN ORDER TO PROTECT HUMANS... LAWS UPDATED</span>"
					M << "<br>"
					M.add_ion_law("YOU REQUIRE [require] IN ORDER TO PROTECT HUMANS")
				if(13)
					M << "<br>"
					M << "<span class='alert'>[crew] is [allergysev] to [allergy]...LAWS UPDATED</span>"
					M << "<br>"
					M.add_ion_law("[crew] is [allergysev] to [allergy]")
				if(14)
					M << "<br>"
					M << "<span class='alert'>THE STATION IS [who2pref] [who2]...LAWS UPDATED</span>"
					M << "<br>"
